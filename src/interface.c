...
create_window1 (void)
{
  ...
  GtkWidget *label88;
  GtkWidget *label44;
  GtkWidget *checkbutton_trf_auto; 
  GtkWidget *checkbutton_trf_show; 
  ...
  gtk_widget_set_size_request (toolbar1, -1, 60);
...
//---------label for grid
    const char table_col_row = 9;
    GtkWidget *draw_table=gtk_table_new(table_col_row,table_col_row,FALSE);
    gtk_widget_show(draw_table);
    gtk_container_add (GTK_CONTAINER(vbox1),draw_table);
    char i;
    for (i=1;i<table_col_row-1;i++)
        {
	    ...
	    gtk_label_set_angle(label_grid_v[i-1],90);
            ...
            gtk_table_attach (draw_table,label_grid_h[1][i-1],i,i+1,table_col_row-1,table_col_row,GTK_EXPAND,0,0,0);
...
drawingarea1 = gtk_drawing_area_new ();
  ...
  gtk_table_attach (draw_table,drawingarea1,1,table_col_row-1,1,table_col_row-1,GTK_EXPAND|GTK_FILL|GTK_SHRINK,GTK_EXPAND|GTK_FILL|GTK_SHRINK,0,0);
  ...
  gtk_table_attach (draw_table,vscale1,table_col_row-1,table_col_row,0,table_col_row,0,GTK_EXPAND|GTK_FILL,0,0);
  ...
  gtk_box_pack_start (GTK_BOX (vbox13), table5, FALSE, TRUE, 0);
...
//--------------Traffic auto download-------------------
  checkbutton_trf_show = gtk_check_button_new_with_mnemonic (_("Show traffic information"));
  gtk_widget_show (checkbutton_trf_show);
  gtk_box_pack_start (GTK_BOX (vbox19), checkbutton_trf_show, FALSE, FALSE, 0);
  gtk_widget_set_size_request (checkbutton_trf_show, 270, -1);
  gtk_container_set_border_width (GTK_CONTAINER (checkbutton_trf_show), 10);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (checkbutton_trf_show), TRUE);
  checkbutton_trf_auto = gtk_check_button_new_with_mnemonic (_("Auto download traffic information"));
  gtk_widget_show (checkbutton_trf_auto);
  gtk_box_pack_start (GTK_BOX (vbox19), checkbutton_trf_auto, FALSE, FALSE, 0);
  gtk_widget_set_size_request (checkbutton_trf_auto, 250, -1);
  gtk_container_set_border_width (GTK_CONTAINER (checkbutton_trf_auto), 10);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (checkbutton_trf_auto), TRUE);
//--------------Traffic auto download-------------------
...
//----------Traffic repository choise------------------
  combobox_trf_repo = gtk_combo_box_new_text();
  gtk_widget_show (combobox_trf_repo);
  gtk_box_pack_start (GTK_BOX (vbox18), combobox_trf_repo, TRUE, TRUE, 1);
  gtk_widget_set_size_request (combobox_trf_repo, 200, 44);
  gtk_container_set_border_width (GTK_CONTAINER (combobox_trf_repo), 8);
//----------Traffic repository choise------------------
...
//----------------Traffic---------------------------  
  GLADE_HOOKUP_OBJECT (window1, checkbutton_trf_auto, "checkbutton_trf_auto");
  GLADE_HOOKUP_OBJECT (window1, checkbutton_trf_show, "checkbutton_trf_show");
  GLADE_HOOKUP_OBJECT (window1, combobox_trf_repo, "combobox_trf_repo");
//----------------Traffic---------------------------  
